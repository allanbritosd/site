...
"use strict";
    ...
    $(document).on('ready', function() {
        ...
        if (window.isMobile()) {
            $('.technologies-session, .activity-session, .fun-fact-session').hide();
            $('.statistics-session').show();
        } else {
            setTimeout(function() {
                $($('.sourcerer')[0]).attr('src', 'https://sourcerer.io/allanbritosd');
                setTimeout(function() {
                    $($('.sourcerer')[1]).attr('src', 'https://sourcerer.io/allanbritosd');
                    setTimeout(function() {
                        $($('.sourcerer')[2]).attr('src', 'https://sourcerer.io/allanbritosd');
                    }, 500);
                }, 500);
            }, 500);
        }

        $('#portfolio_grid .item a').mouseenter(function(e){
            $(this).attr('title', '');
        });
        $('#portfolio_grid .item a').mousedown(function(e){
            $(this).attr('title', $(this).data('title'));
        });

        $(document).on('click', '.see_details', function() {
          $(this).closest('.div_details').toggleClass('active')
        });
    });
